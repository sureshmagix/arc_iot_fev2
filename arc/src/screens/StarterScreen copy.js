        ...
        <View>
          <View style={{position: 'relative'}}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('UpdateStarter', {data: userData});
              }}>
          ...
          <View style={{marginTop: -50}}>
            ...
            <Text style={styles.infoLarge_Text}>Your Registered Archidtech Starters</Text>
          </View>
          ...
          <View style={{marginTop: 10, marginHorizontal: 25}}>
              ...
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  ...
                  <Text style={styles.infoLarge_Text}>
                    {userData.starter1 == '' ||
                    userData.starter1 == undefined ||
                    userData.starter1 == null
                      ? ''
                      : userData.starter1}
                  </Text>
                </View>
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                <View style={[styles.infoIconCont, {backgroundColor: '#774BBC'}]}>
                  <Profession name="Starter" size={24} style={{color: 'white'}}  />
                </View>
                <View style={styles.infoText}>
