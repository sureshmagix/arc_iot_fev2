...
function CallScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../assets/callImage.jpg')} style={styles.callImageStyle} />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    ...
    zIndex: 1, // Keep the content above the background image
  },
  buttonStyle: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  callImageStyle: {
    ...
    resizeMode: 'cover',
    zIndex: 0,  // Ensure it stays as the background
  },
});
