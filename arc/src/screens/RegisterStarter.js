...
import styles from './Login&Register/UpdateProfile/stylesProfileEdit';
    ...
    <ScrollView
      ...
      <View>
        <View style={styles.header}>
          ...
          <View style={{flex: 3}}>
            <Text style={styles.nameText}>Register starters</Text>
          </View>
        ...
        <View
          ...
          <Text style={styles.titleTextsmall}>User Mobile: {userData.mobile} </Text>
        ...
        <View style={styles.button}>
          <TouchableOpacity
            onPress={() =>RegisterStarter()}
            style={styles.inBut}>
            <View>
              <Text style={styles.textSign}>Register Starter</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
...
export default RegisterStarter;